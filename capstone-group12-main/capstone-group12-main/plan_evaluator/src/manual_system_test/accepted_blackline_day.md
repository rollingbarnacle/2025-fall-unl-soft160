...
4.  Type 'accepted_blackline_day.json' into the prompt that asks for the JSON file name and press enter.
...
10. type '800' for the acres of land to burn

11. type 'blacklines' for the fire type
...
19. type '500' for blackline width

20. type 'volatile' for blackline fuel condition
